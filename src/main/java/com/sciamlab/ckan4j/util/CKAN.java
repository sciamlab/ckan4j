...
public class CKAN {
	...
	public class ODH {
		...
		public static final String RESOURCES_EXTRAS = "resources_extras";	
		public static final String SPC = "spc";	
		public static final String AMACA = "amaca";	
		public static final String DBPEDIA = "dbpedia";	
		public static final String TEMPORAL_START = "temporal_start";	
		public static final String TEMPORAL_END = "temporal_end";	
		public static final String FREQUENCY = "frequency";	
		public static final String FREQUENCY_URI = "frequency-uri";	
...
//		public static final String DCAT_CATEGORY_NAME_EN = "dcat-category-name-en";	
		public static final String CATEGORY_URI = "category-uri";	
